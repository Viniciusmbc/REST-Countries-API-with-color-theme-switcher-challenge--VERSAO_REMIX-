...
var require_lodash = __commonJS({
  "node_modules/lodash.clonedeep/index.js"(exports, module) {
    ...
    function baseClone(value, isDeep2, isFull, customizer, key, object, stack) {
      var result;
      if (customizer) {
      ...
      if (isArr) {
        ...
        if (tag == objectTag || tag == argsTag || isFunc && !object) {
          ...
          result = initCloneByTag(value, tag, baseClone, isDeep2);
        }
      }
      ...
      arrayEach(props || value, function(subValue, key2) {
        ...
        assignValue(result, key2, baseClone(subValue, isDeep2, isFull, customizer, key2, value, stack));
      });
      return result;
    }
    ...
    function cloneMap(map, isDeep2, cloneFunc) {
      var array = isDeep2 ? cloneFunc(mapToArray(map), true) : mapToArray(map);
    ...
    function cloneSet(set, isDeep2, cloneFunc) {
      var array = isDeep2 ? cloneFunc(setToArray(set), true) : setToArray(set);
    ...
    function initCloneByTag(object, tag, cloneFunc, isDeep2) {
      ...
      switch (tag) {
        ...
        case mapTag:
          return cloneMap(object, isDeep2, cloneFunc);
        case numberTag:
        case stringTag:
          return new Ctor(object);
        case regexpTag:
        ...
        case setTag:
          return cloneSet(object, isDeep2, cloneFunc);
        case symbolTag:
...
var untransformValue = function(json4, type) {
  if (isArray(type)) {
    switch (type[0]) {
      case "symbol":
        return symbolRule.untransform(json4, type);
      case "class":
        return classRule.untransform(json4, type);
      case "custom":
        return customRule.untransform(json4, type);
      case "typed-array":
        return typedArrayRule.untransform(json4, type);
      default:
    ...
    return transformation.untransform(json4);
  }
};
...
var walker = function(object, identities, path, objectsInThisPath) {
  ...
  forEach(transformed, function(value, index) {
    var recursiveResult = walker(value, identities, __spreadArray2(__spreadArray2([], __read3(path)), [index]), objectsInThisPath);
...
var deserialize = function(payload) {
  var json4 = payload.json, meta = payload.meta;
  var result = (0, import_lodash.default)(json4);
...
// node_modules/superjson-remix/dist/superjson-remix.esm.js
var json2 = function json3(obj, init) {
  var superJsonResult = serialize(obj);
...
async function getCountries() {
  ...
  const countries = json2(await response.json());
  return countries;
}
...
//# sourceMappingURL=/build/_shared/chunk-47OQS35X.js.map
