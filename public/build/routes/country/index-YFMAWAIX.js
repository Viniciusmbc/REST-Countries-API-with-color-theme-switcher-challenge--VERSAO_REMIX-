...
var untransformValue = function(json3, type) {
  if (isArray(type)) {
    switch (type[0]) {
      case "symbol":
        return symbolRule.untransform(json3, type);
      case "class":
        return classRule.untransform(json3, type);
      case "custom":
        return customRule.untransform(json3, type);
      case "typed-array":
        return typedArrayRule.untransform(json3, type);
      default:
    ...
    return transformation.untransform(json3);
  }
};
...
var deserialize = function(payload) {
  ...
  var result = (0, import_lodash.default)(json3);
