...
function Index() {
  ...
  })), /* @__PURE__ */ React.createElement("div", null, countries.filter(({ name }) => {
    if (name === "") {
      return countries;
  ...
  }, /* @__PURE__ */ React.createElement("b", null, "Population:"), " ", population), /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("b", null, "Region:"), " ", region), /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("b", null, "Capital:"), " ", capital))).splice(0, 8)));
}
export {
  Index as default
};
//# sourceMappingURL=/build/routes/index-JUZNHIC7.js.map
